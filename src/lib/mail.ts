...
export const sendVerificationEmail = async (
  ...
  const outgoingEmail = {
    ...
    <b>This is link is only valid for 24 hours.</b>
    \r\n
  ...
  switch (lang) {
    case 'fr':
      ...
      <b>Ce lien n'est valable que pendant 24 heures.</b>
      \r\n
...
export const sendPasswordResetEmail = async (
  ...
  const outgoingEmail = {
    ...
    <b>This is link is only valid for 2 hours.</b>
    \r\n
  ...
  switch (lang) {
    case 'fr':
      ...
      <b>Ce lien n'est valable que pendant 2 heures.</b>
      \r\n
